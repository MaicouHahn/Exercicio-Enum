...
public class Worker {
	...
	private List<HourContract> contracts = new ArrayList<>();// lista pois um trabalhador pode ter varios contratos
	// e tambem pois nao e sabe o numero limite de posições para esses contratos,
	// nao dando para usar vetores
